...
public class Main {
    ...
    static void writeIntoOptAssemblyFile(String line) {
        try {
            if (optAssemblyFile != null) {
                optAssemblyFile.write(line + "\n");
                optAssemblyFile.flush();
            }
        } catch (Exception e) {
            System.err.println("Error writing to optimized assembly file: " + e.getMessage());
        }
    }
    ...
    public static BufferedWriter assemblyFile;
    public static BufferedWriter optAssemblyFile;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String optAssemblyFileName = outputDirectory + "optimized_code.asm";
        ...
        assemblyFile = new BufferedWriter(new FileWriter(assemblyFileName));
        optAssemblyFile = new BufferedWriter(new FileWriter(optAssemblyFileName));
